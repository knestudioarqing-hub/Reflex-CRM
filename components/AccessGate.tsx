...
export const AccessGate: React.FC<AccessGateProps> = ({ onAccessGranted, lang }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#050505] text-white overflow-hidden font-sans">
      
      {/* Background Cyberpunk Effects */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
          <div className="absolute top-[-20%] left-[20%] w-[500px] h-[500px] bg-orange-500/10 rounded-full blur-[100px] animate-pulse" />
          <div className="absolute bottom-[-10%] right-[20%] w-[500px] h-[500px] bg-orange-600/10 rounded-full blur-[100px] animate-pulse delay-500" />
      ...
      <div className="relative z-10 w-full max-w-md p-8 animate-scale-in">
         ...
         <div className="flex justify-center mb-8">
            <div className="w-20 h-20 rounded-2xl bg-[#050505] border border-white/10 flex items-center justify-center shadow-2xl shadow-orange-500/20 relative group">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-orange-500/20 to-orange-600/20 opacity-0 group-hover:opacity-100 transition-opacity" />
                <Shield size={40} className={`text-white transition-all duration-500 ${loading ? 'scale-90 opacity-50' : 'scale-100'}`} />
                {loading && (
                    <div className="absolute inset-0 border-2 border-orange-500/50 rounded-2xl animate-ping" />
                )}
            </div>
         </div>
                ...
                <div className="animate-fade-in space-y-6">
                    ...
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="w-full bg-[#050505] border border-slate-700 rounded-xl py-4 pl-12 pr-4 text-center text-2xl font-mono tracking-widest text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all placeholder-slate-600"
                            autoFocus
                        />
                    </div>
            ...
            {step === 'detecting' && (
                <div className="flex flex-col items-center justify-center py-8 animate-fade-in text-center space-y-4">
                    <div className="relative">
                        ...
                        <div className="absolute inset-0 border-t-2 border-orange-400 rounded-full animate-spin" />
                    </div>
                    <div>
            ...
            {step === 'linking' && (
                <div className="flex flex-col items-center justify-center py-8 animate-fade-in text-center space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-orange-400 font-mono mt-1">IP: {detectedIP}</p>
                    </div>
                </div>
            )}
